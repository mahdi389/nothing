...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for se in self.knowledge:
            if s.cells.issubset(se.cells):
                inference = Sentence(se.cells - s.cells , se.count-s.count)
                self.knowledge.append(inference)
                self.knowledge.append(s)
                self.knowledge.remove(se)
                issubset = True
            if se.cells.issubset(s.cells):
                inference = Sentence(s.cells - se.cells , s.count-se.count)
                self.knowledge.append(inference)
                issubset = True
        if issubset == False:
            self.knowledge.append(s)
